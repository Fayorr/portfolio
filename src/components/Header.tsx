...
export function Header() {
	...
	if (!mounted) {
		return (
			<header className='bg-[#ffffff] dark:bg-[#0f172a] border-b-2 border-orange-500 fixed top-0 left-0 right-0 z-[51] w-full'>
				<div className='flex justify-between items-center py-7 px-10 md:px-20 mx-auto w-full max-w-7xl'>
					<div>
						<Link href='/'>
					...
					<AlignRight className='block md:hidden cursor-pointer' />
	...
	return (
		<header className='bg-[#ffffff] dark:bg-[#0f172a] border-b-2 border-orange-500 fixed top-0 left-0 right-0 z-50 w-full'>
			<div className='flex justify-between items-center py-7 px-10 md:px-20 mx-auto w-full max-w-7xl'>
				<div>
					<Link href='/'>
